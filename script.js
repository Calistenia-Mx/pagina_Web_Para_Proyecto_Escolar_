...
function addToCart(id) {
    ...
    cartOverlay.classList.add('active'); // <-- añade esta línea
...
//MENU DESPEGABLE (PRODUCTOS HOMBRE,MUJER,JOVEN,NUEVOS MODELOS)
// Obtener elementos
...
function toggleMenu(event) {
    event.preventDefault(); // Evita que el enlace navegue a #productos
    coleccionMenu.classList.toggle('show');
}

// Abrir/cerrar al hacer clic en "Colección"
coleccionLink.addEventListener('click', toggleMenu);
...
// Cerrar al hacer clic en una opción del menú (opcional)
coleccionMenu.querySelectorAll('a').forEach(link => {
    link.addEventListener('click', function() {
        coleccionMenu.classList.remove('show');
        // Si deseas que además navegue a la sección, no hagas nada más
        // Si quieres evitar la navegación, puedes usar preventDefault
        // pero normalmente queremos que lleve a la sección.
    });
});