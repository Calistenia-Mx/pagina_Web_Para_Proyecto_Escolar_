...
<head>
    ...
    <title>KIVY STREET | Nuevos Modelos</title>
...
<body>
    ...
    <div class="header-section">
        <h1 class="section-title" style="color: white;">Nuevos Modelos</h1>
        <p>Lo más reciente en nuestra tienda.</p>
    </div>
    ...
    <script>
        ...
        async function loadProductsByCategory() {
            const res = await fetch('obtener_productos.php?categoria=Nuevos');
