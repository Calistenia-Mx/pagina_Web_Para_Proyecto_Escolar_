...
<head>
    ...
    <title>KIVY STREET | Productos Joven</title>
...
<body>
    ...
    <div class="header-section">
        <h1 class="section-title" style="color: white;">Productos Joven</h1>
        <p>Tendencias para las nuevas generaciones.</p>
    </div>
    ...
    <script>
        ...
        async function loadProductsByCategory() {
            const res = await fetch('obtener_productos.php?categoria=Jovenes');
